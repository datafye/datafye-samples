...
public class IsQuoteDownloadRunning {
    ...
    final private static void run(final String dataset) {
        ...
        IsStocksQuoteHistoryFetchRunningRequestMessage request = IsStocksQuoteHistoryFetchRunningRequestMessage.create();
        IsStocksQuoteHistoryFetchRunningResponseMessage response = client.isQuoteHistoryFetchRunning(request);
