...
public class CancelTickDownload {
    ...
    final private static void run(final String dataset) {
        ...
        // cancel the download
        CancelStocksTickHistoryFetchRequestMessage request = CancelStocksTickHistoryFetchRequestMessage.create();
        CancelStocksTickHistoryFetchResponseMessage response = client.cancelTickHistoryFetch(request);
