 ...
 */
package com.datafye.samples.java.stocks.backtest;
...
public class StartTradeDownload {
    ...
    final private static void run(final String dataset, final Date date, final String[] symbols, final boolean wait) throws Exception {
        ...
        StartStocksTradeHistoryFetchResponseMessage response = client.startTradeHistoryFetch(request);
        ...
        if (wait) {
            ...
            while (true) {
                ...
                IsStocksTradeHistoryFetchRunningRequestMessage statusRequest = IsStocksTradeHistoryFetchRunningRequestMessage.create();
                IsStocksTradeHistoryFetchRunningResponseMessage statusResponse = client.isTradeHistoryFetchRunning(statusRequest);
