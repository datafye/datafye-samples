...
public class StopTickReplay {
    ...
    final private static void run(final String dataset) {
        ...
        // stop the replay
        StopHistoricalStocksTickReplayRequestMessage request = StopHistoricalStocksTickReplayRequestMessage.create();
        StopHistoricalStocksTickReplayResponseMessage response = client.stopHistoricalTickReplay(request);
        response.dispose();
