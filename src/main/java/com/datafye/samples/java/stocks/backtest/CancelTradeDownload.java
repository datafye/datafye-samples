...
public class CancelTradeDownload {
    ...
    final private static void run(final String dataset) {
        ...
        // cancel the download
        CancelStocksTradeHistoryFetchRequestMessage request = CancelStocksTradeHistoryFetchRequestMessage.create();
        CancelStocksTradeHistoryFetchResponseMessage response = client.cancelTradeHistoryFetch(request);
