...
public class IsTickReplayRunning {
    ...
    final private static void run() {
        ...
        IsHistoricalCryptoTickReplayRunningRequestMessage request = IsHistoricalCryptoTickReplayRunningRequestMessage.create();
        IsHistoricalCryptoTickReplayRunningResponsetMessage response = client.isHistoricalTickReplayRunning(request);
