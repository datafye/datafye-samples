...
public class CancelQuoteDownload {
    ...
    final private static void run() {
        ...
        // cancel the download
        CancelCryptoQuoteHistoryFetchRequestMessage request = CancelCryptoQuoteHistoryFetchRequestMessage.create();
        CancelCryptoQuoteHistoryFetchResponseMessage response = client.cancelQuoteHistoryFetch(request);
