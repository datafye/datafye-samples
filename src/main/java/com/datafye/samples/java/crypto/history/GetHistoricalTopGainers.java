...
public class GetHistoricalTopGainers {
    ...
    final private static void run(final Date date) {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            GetTopGainerCryptoRequestMessage request = GetTopGainerCryptoRequestMessage.create();
            request.setDate(date);
            GetTopGainerCryptoResponseMessage response = client.getTopGainers(request);
