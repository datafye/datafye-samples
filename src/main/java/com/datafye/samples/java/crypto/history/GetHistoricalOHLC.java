...
public class GetHistoricalOHLC {
    ...
    final private static void run(final String symbol, final String frequency, final Date from, final Date to) {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            GetHistoricalCryptoOHLCsRequestMessage request = GetHistoricalCryptoOHLCsRequestMessage.create();
            ...
            GetHistoricalCryptoOHLCsResponseMessage response = client.getHistoricalOHLCs(request);
