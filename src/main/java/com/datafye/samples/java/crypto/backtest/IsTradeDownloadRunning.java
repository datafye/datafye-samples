...
public class IsTradeDownloadRunning {
    ...
    final private static void run() {
        ...
        IsCryptoTradeHistoryFetchRunningRequestMessage request = IsCryptoTradeHistoryFetchRunningRequestMessage.create();
        IsCryptoTradeHistoryFetchRunningResponseMessage response = client.isTradeHistoryFetchRunning(request);
