 ...
 */
package com.datafye.samples.java.crypto.live.ticks;
...
public class GetLiveTopOfBook {
    ...
    final private static void run(final String commaSeparatedSymbols) {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            GetLiveTopOfBookCryptoQuotesRequestMessage request = GetLiveTopOfBookCryptoQuotesRequestMessage.create();
            request.setSymbols(symbols);
            GetLiveTopOfBookCryptoQuotesResponseMessage response = client.getLiveTopOfBookQuotes(request);
