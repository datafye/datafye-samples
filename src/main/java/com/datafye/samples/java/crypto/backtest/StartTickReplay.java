    ...
    final private static void run(final String date, final boolean wait) throws Exception {
        ...
        if (wait) {
            ...
            while (true) {
                ...
                IsHistoricalCryptoTickReplayRunningRequestMessage statusRequest = IsHistoricalCryptoTickReplayRunningRequestMessage.create();
                IsHistoricalCryptoTickReplayRunningResponsetMessage statusResponse = client.isHistoricalTickReplayRunning(statusRequest);
