...
public class IsTickDownloadRunning {
    ...
    final private static void run() {
        ...
        IsCryptoTickHistoryFetchRunningRequestMessage request = IsCryptoTickHistoryFetchRunningRequestMessage.create();
        IsCryptoTickHistoryFetchRunningResponseMessage response = client.isTickHistoryFetchRunning(request);
