...
/**
 * Streams historical OHLC bars using the Crypto History client.
 */
public class StreamHistoricalOHLC {
    ...
    final private void run(final String symbol, final Date from, final Date to, final int rate) throws Exception {
        ...
        OpenHistoricalCryptoOHLCStreamResponseMessage response = client.openHistoricalOHLCStream(request);
