 ...
 */
package com.datafye.samples.rest.crypto.reference;
...
public class GetSecurities {
    ...
    final private static void run() throws Exception {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/crypto/reference/securities").newBuilder();
