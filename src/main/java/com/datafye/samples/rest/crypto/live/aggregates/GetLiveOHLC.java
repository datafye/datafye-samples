...
public class GetLiveOHLC {
    ...
    final private static void run(final String symbol) throws Exception {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/crypto/live/agg/ohlcs").newBuilder();
            ...
            GetLiveCryptoOHLCResponse ohlcResponse = objectMapper.readValue(response.body().string(), GetLiveCryptoOHLCResponse.class);
