 ...
 */
package com.datafye.samples.rest.crypto.backtest;
...
public class IsOHLCDownloadRunning {
    ...
    final private static void run(final String frequency) throws Exception {
        ...
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/crypto/backtest/history/ohlcs").newBuilder();
