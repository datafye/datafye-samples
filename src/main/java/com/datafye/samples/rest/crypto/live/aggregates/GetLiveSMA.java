 ...
 */
package com.datafye.samples.rest.crypto.live.aggregates;
...
public class GetLiveSMA {
    ...
    final private static void run(final String symbol) throws Exception {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/crypto/live/agg/smas").newBuilder();
