...
public class StopTickReplay {
    ...
    final private static void run() throws Exception {
        ...
        // stop the replay
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/backtest/history/ticks/replay/stop").newBuilder();
