...
public class IsQuoteDownloadRunning {
    ...
    final private static void run() throws Exception {
        ...
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/backtest/history/quotes/fetch/status").newBuilder();
