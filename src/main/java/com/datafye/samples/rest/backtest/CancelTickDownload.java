...
public class CancelTickDownload {
    ...
    final private static void run() throws Exception {
        ...
        // cancel the download
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/backtest/history/ticks/fetch/stop").newBuilder();
