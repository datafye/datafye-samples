...
public class CancelTradeDownload {
    ...
    final private static void run() throws Exception {
        ...
        // cancel the download
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/backtest/history/trades/fetch/stop").newBuilder();
