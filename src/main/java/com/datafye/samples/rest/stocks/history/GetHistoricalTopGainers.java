...
public class GetHistoricalTopGainers {
    ...
    final private static void run(final String dataset, final Date date) throws Exception {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/stocks/history/top-gainers").newBuilder();
