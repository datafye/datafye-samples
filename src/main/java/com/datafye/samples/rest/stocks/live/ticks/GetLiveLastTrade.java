 ...
 */
package com.datafye.samples.rest.stocks.live.ticks;
...
public class GetLiveLastTrade {
    ...
    final private static void run(final String dataset, final String symbols) throws Exception {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/stocks/live/trades/latest").newBuilder();
            ...
            GetLiveLastTradeResponse tradeResponse = objectMapper.readValue(response.body().string(), GetLiveLastTradeResponse.class);
