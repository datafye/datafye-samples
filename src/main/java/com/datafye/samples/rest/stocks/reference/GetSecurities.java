 ...
 */
package com.datafye.samples.rest.stocks.reference;
...
public class GetSecurities {
    ...
    final private static void run(final String dataset) throws Exception {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            GetSecuritiesResponse securitiesResponse = objectMapper.readValue(response.body().string(), GetSecuritiesResponse.class);
            long stop = System.currentTimeMillis();

            // update totals
            totalTime += (stop-start);
            totalCount += securitiesResponse.getSecurities() != null ? securitiesResponse.getSecurities().length : 0;
        }
