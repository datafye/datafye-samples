...
public class CancelTradeDownload {
    static {
    ...
    final private static void run(final String dataset) throws Exception {
        ...
        // cancel the download
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/stocks/backtest/history/trades").newBuilder();
        ...
        if (statusResponse.getStatus() != null) {
            ...
            System.out.println("Trade history download cancelled successfully.");
        }
    }
