...
public class IsOHLCDownloadRunning {
    ...
    final private static void run(final String dataset, final String frequency) throws Exception {
        ...
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/stocks/backtest/history/ohlcs").newBuilder();
        ...
        System.out.println(frequency + " OHLC history download is running: " + isRunningResponse.getIsRunning());
    }
