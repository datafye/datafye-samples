 ...
 */
package com.datafye.samples.rest.stocks.history;
...
public class GetHistoricalOHLC {
    ...
    final private static void run(final String dataset, final String symbol, final String frequency, final Date from, final Date to) throws Exception {
        ...
        for (int i = 0 ; i < 100 ; i++) {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse("http://" + Config.getValue("datafye-samples.api.endpoint") + "/datafye-api/v1/stocks/history/ohlcs").newBuilder();
