...
public class StartOHLCDownload {
    ...
    final private static void run(final String dataset, final String date, final String symbols, final String frequency, final boolean wait) throws Exception {
    ...
    public static void main(String args[]) throws Exception {
        ...
        if (!((Boolean)parser.getOptionValue(helpOption, false))) {
            ...
            // execute
            run(dataset, date, symbols, frequency, wait);
        }
        else {
            printUsage();
        }
