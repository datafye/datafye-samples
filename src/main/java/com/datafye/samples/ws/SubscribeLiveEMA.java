...
/**
 * Streams live EMA (exponential moving average / MACD) values over a WebSocket from a Datafye Deployment.
 *
 * Connects to {@code /datafye-ws/v1/stocks/live/ema}, subscribes to the given symbols at a frequency, and
 * prints each computed EMA frame as it arrives. Available for the SIP, Synthetic and Crypto datasets.
 *
 * Note: an EMA only streams when that frequency's OHLC {@code publish} and EMA {@code process} are enabled
...
public class SubscribeLiveEMA {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        StreamClient.stream(StreamClient.wsUrl("stocks/live/ema"), subscribe, seconds);
    }
}
