...
/**
 * Streams live OHLC bars over a WebSocket from a Datafye Deployment.
 *
 * Connects to {@code /datafye-ws/v1/stocks/live/aggs}, subscribes to the given symbols at a frequency, and
 * prints each finalized OHLC bar frame as it arrives. Available for the SIP, Synthetic and Crypto datasets.
 *
...
public class SubscribeLiveOHLC {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        StreamClient.stream(StreamClient.wsUrl("stocks/live/aggs"), subscribe, seconds);
    }
}
