...
/**
 * Streams live trades over a WebSocket from a Datafye Deployment.
 *
 * Connects to {@code /datafye-ws/v1/stocks/live/ticks}, subscribes to the given symbols, and prints each
 * live trade frame as it arrives. Available for the SIP, Synthetic and Crypto datasets.
 *
...
public class SubscribeLiveTrades {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        StreamClient.stream(StreamClient.wsUrl("stocks/live/ticks"), subscribe, seconds);
    }
}
